...
<head>
    ...
    <link rel="stylesheet" href="{{asset('ui/frontend')}}/vendors/linericon/style.css" />
    <link rel="stylesheet" href="{{asset('ui/frontend')}}/css/font-awesome.min.css" />
    <link rel="stylesheet" href="{{asset('ui/frontend')}}/css/themify-icons.css" />
    <link rel="stylesheet" href="{{asset('ui/frontend')}}/css/flaticon.css" />
...
<body>
   ...
   @yield('content');
    ...
    <script src="{{asset('ui/frontend')}}/js/jquery-3.2.1.min.js"></script>
    <script src="{{asset('ui/frontend')}}/js/popper.js"></script>
    <script src="{{asset('ui/frontend')}}/js/bootstrap.min.js"></script>
    <script src="{{asset('ui/frontend')}}/js/stellar.js"></script>
    ...
    <script src="{{asset('ui/frontend')}}/js/theme.js"></script>


    <!-- contact js -->
    <script src="{{asset('ui/frontend')}}/js/jquery.form.js"></script>
    <script src="{{asset('ui/frontend')}}/js/jquery.validate.min.js"></script>
    <script src="{{asset('ui/frontend')}}/js/contact.js"></script>
    <!--gmaps Js-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
    <script src="{{asset('ui/frontend')}}/js/gmaps.min.js"></script>
    <script src="{{asset('ui/frontend')}}/js/theme.js"></script>
    </body>
</body>
