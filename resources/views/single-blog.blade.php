                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{asset('ui/frontend')}}/img/blog/main-blog/m-blog-1.jpg" alt="">
                        </div>
                    ...
                    <div class="blog-author">
                        <div class="media align-items-center">
                            <img src="{{asset('ui/frontend')}}/img/blog/author.png" alt="">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img src="{{asset('ui/frontend')}}/img/blog/popular-post/post1.jpg" alt="post">
                                <div class="media-body">
                            ...
                            <div class="media post_item">
                                <img src="{{asset('ui/frontend')}}/img/blog/popular-post/post2.jpg" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                            ...
                            <div class="media post_item">
                                <img src="{{asset('ui/frontend')}}/img/blog/popular-post/post3.jpg" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                            ...
                            <div class="media post_item">
                                <img src="{{asset('ui/frontend')}}/img/blog/popular-post/post4.jpg" alt="post">
                                <div class="media-body">
                                    <a href="single-blog.html">
                        ...
                        <aside class="single_sidebar_widget instagram_feeds">
                            ...
                            <ul class="instagram_row flex-wrap">
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('ui/frontend')}}/img/instagram/widget-i1.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('ui/frontend')}}/img/instagram/widget-i2.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('ui/frontend')}}/img/instagram/widget-i3.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('ui/frontend')}}/img/instagram/widget-i4.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('ui/frontend')}}/img/instagram/widget-i5.png" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('ui/frontend')}}/img/instagram/widget-i6.png" alt="">
                                    </a>
                                </li>
                            </ul>
                        </aside>
